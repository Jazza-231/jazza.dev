<script lang="ts">
	...
	const models = ["/models/Pro laptop model.glb", "/models/Noob laptop model.glb"];
...
<T.DirectionalLight position={[-2, 5, 2]} intensity={2} castShadow shadow.bias={-0.0001} />
<T.DirectionalLight position={[3, 3, -2]} intensity={1.5} shadow.bias={-0.0001} />
<T.DirectionalLight position={[0.4, -0.5, -2]} intensity={0.5} shadow.bias={-0.0001} />
...
{@render RotatingText([0, rotation, 0], modelsData[model].text1, "Lenovo Legion Pro 7i Gen 8")}

{@render RotatingText([0, rotation, 0], modelsData[model].text2, "240hz, 2560x1600", [-0.2, 0, 0])}

{@render RotatingText([0, rotation, 0], modelsData[model].text3, "2x4TB SSD, 32GB RAM", [
	-Math.PI / 2,
	0,
	0,
])}

{@render RotatingText([0, rotation, 0], modelsData[model].text4, "RTX 4070, i9-13900hx", [
	0.5,
	Math.PI,
	0,
])}
