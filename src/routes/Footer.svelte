...
<footer>
	<div class="footer-container">
		...
		<div class="icons">
			{#each icons as icon}
				<div class={icon.name}>
					<a href={icon.link} target="_blank" aria-label={makeLabel(icon.name)}>
						<svelte:component this={Icons[`${toTitleCase(icon.name)}Dev` as keyof typeof Icons]} />
					</a>
				</div>
			{/each}
		</div>
		<div class="contact">
			Contact me at <a class="internal-link" href="mailto:admin@jazza.dev">admin@jazza.dev</a>
		</div>
	</div>
</footer>
